            ...
            <div class="card-body">
                <div class="basic-form">
                    @if (count($errors))
                     ...
                     @endif
                    <form method="POST" action="{{route('admission.update')}}" enctype="multipart/form-data">

                        @csrf
                        @method('POST')
                        <div class="form-group mb-3 mt-3">
                            <label for="">Name</label><span class="text-danger fs-4">*</span>
                            <input class="form-control " value="{{$admission->name}}" name="name" type="text" placeholder="">
                        </div>

                        <div class="form-group mb-3 mt-3">
                            <label for="">Name Kurdish</label><span class="text-danger fs-4">*</span>
                            <input class="form-control text-end" dir="rtl" value="{{$admission->name_ku}}" name="name_ku" type="text" placeholder="">
                        </div>
                        ...
                        <div class="form-group mb-5">
                            ...
                            margin-top: 10px;">
                                <div class="card mb-3">
                                    <img class="img-fluid" src="{{asset('images/admission/'.$admission->image)}}" style="width: 100%;height:100%" id="imagePreview" src=""  alt="Image Preview">
